...
type Props = { filters: Filters; setFilters: (filters: Filters) => void; lobs: string[]; partners: string[] };
export function TrackerToolbar({ filters, setFilters, lobs, partners }: Props) {
