import type { CurrentUser, ManagedUser, PromoDto } from "../../types";
...
export const createUser = (email: string, password: string, role: CurrentUser["role"]) => apiFetch<ManagedUser>("/api/users", { method: "POST", body: JSON.stringify({ email, password, role }) });
